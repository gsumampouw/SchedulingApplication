...
public class HomeCntrl implements Initializable {
    ...
    public void addCustomer(ActionEvent event) throws IOException {
        navigation.navigateToPage(event, "/main/schedulemanager/views/AddCustomer.fxml");
    }
    ...
    public void updateCustomer(ActionEvent event) throws IOException {
        ...
        if (selectedCustomer != null) {
            ...
            scene = FXMLLoader.load(getClass().getResource("/main/schedulemanager/views/UpdateCustomer.fxml"));
    ...
    public void toReportCustomerAppt(ActionEvent actionEvent) throws IOException {
        navigation.navigateToPage(actionEvent, "/main/schedulemanager/views/ReportCustomerAppt.fxml");
    }
    ...
    public void toReportContactSchedule(ActionEvent actionEvent) throws IOException {
        navigation.navigateToPage(actionEvent, "/main/schedulemanager/views/ReportContactSchedule.fxml");
    }
    ...
    public void toUserSchedule(ActionEvent actionEvent) throws IOException {
        navigation.navigateToPage(actionEvent, "/main/schedulemanager/views/ReportUserSchedule.fxml");
    }
}
